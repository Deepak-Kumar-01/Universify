                            ...
                            return ListTile(
                              ...
                              trailing: ElevatedButton(
                                ...
                                style: ButtonStyle(
                                  ...
                                  foregroundColor: MaterialStateProperty.all<Color>(Colors.white), // Text and icon color
                                ),
                                child: const Text(
                                  'Mark as Complete',
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ListTile(
                              ...
                              trailing: ElevatedButton(
                                onPressed: () {},
                                style: ButtonStyle(
                                  backgroundColor: MaterialStateProperty.all<Color>(Colors.green), // Button background color
